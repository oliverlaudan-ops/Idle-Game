...
const achievementsList = [
  ...
  new Achievement({
    ...
    name: 'Punkt-Sammler',
    desc: 'Erreiche 100 Prestige-Punkte',
    category: 'prestige',
    icon: '🎯',
    checkFn: (game) => (game.totalPrestigePoints || 0) >= 100,
    hidden: true
  }),
  ...
  new Achievement({
    ...
    hidden: true,
    rewardFn: (game) => {
      // +20% Produktionsgeschwindigkeit
      game.tickMs = Math.max(500, game.tickMs * 0.8);
    }
  }),
